...
last_modified_at: 2023-05-16 01:21:56 UTC+09:00
---
...
객체변수 level, hit_point, atk, type은 생성자 메서드가 호출될 때 실행되는 super(...).\_init__() 부분에서 할당되도록 되어 있습니다.  그런데 \_init__이 생성자라는 것은 알겠지만 super(...)가 무엇인지, 생성자 아래에 다시 생성자가 나오는 이유는 무엇인지는 생소합니다.
