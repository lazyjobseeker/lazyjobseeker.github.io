...
for (step = 0; step < size; step++) {
    ...
    var date_rqst = new XMLHttpRequest();
    ...
    date_rqst.open('GET', 'https://lazyjobseeker.goatcounter.com/counter/TOTAL.json?start=' + todayisostring.slice(0, 10) + '&end=' + tomorrowisostring.slice(0, 10));
    date_rqst.send();
}
