...
const jsonFile_totalpv = "https://lazyjobseeker.github.io/assets/json/gctotalpageviews.json";

fetch(jsonFile_totalpv)
  .then(res => res.json())
  .then(data => {
    document.querySelector('#gc_total').innerText = data.TOTAL.toLocaleString();
  });
