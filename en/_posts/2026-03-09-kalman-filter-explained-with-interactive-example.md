---
title: "Understanding the Kalman Filter: An Interactive Example and Step-by-Step Breakdown"
...
published: true
---
## Introduction - Mouse Cursor Tracker
...
First of all, we expect we can **predict** a state variable (or a set of variables) in any step $k$ from its previous step $k-1$.
...
$v_k$ is the observation noise. It is assumed to follow $\mathcal{N}(0, R_k)$, where $R_k$ is the covariance of the observation noise.
